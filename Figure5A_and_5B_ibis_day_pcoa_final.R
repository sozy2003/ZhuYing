...
q= p + scale_color_gradientn(colours=rainbow(7))
 beta_pcoa_day_bray_curtis1v2 <- q
 beta_pcoa_day_bray_curtis1v2
# ggsave("beta_pcoa_day_bray_curtis1v2_20210607.pdf", beta_pcoa_day_bray_curtis1v2, width = 4, height = 2.5)



# plot PCo 1 and 3
p = ggplot(points, aes(x=x, y=z,  color=Day))
p = p + geom_point(alpha=.7, size=2) +
...
p = p + geom_point(alpha=.7, size=2) +
 ...
 beta_pcoa_phase_bray_curtis1v2
# ggsave("beta_pcoa_phase_bray_curtis1v2_20210607.pdf", beta_pcoa_phase_bray_curtis1v2, width = 4, height = 2.5)
...
p
 ...
 p
# according to the above plot, we only include age and stages in the model
